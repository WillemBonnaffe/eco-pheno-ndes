...
pdf(file = "figures-2026-03-03.pdf", width = 12, height = 12)
...
print(r2)
write.table(x=r2, file="tab-r2-population.csv", sep=",", row.names=F)
...
r2 = 1 - sd(residuals)/sd(Y_[,rv_idx])
print(r2)
write.table(x=r2, file="tab-r2-phenotype.csv", sep=",", row.names=F)
